...
export default function DeliveryChargeConfig() {
  ...
  if (loading) {
    return (
      <div className="glass-panel p-8 rounded-2xl border border-slate-150 animate-pulse space-y-6 max-w-xl mx-auto mt-6">
    ...
    <div className="space-y-6 max-w-xl mx-auto">
      ...
      <div className="text-left pb-4 border-b border-slate-100">
        ...
        <p className="text-slate-500 text-xs font-sans mt-1">
          Manage shipping rates mapping directly to the client checkout page.
        </p>
      </div>
